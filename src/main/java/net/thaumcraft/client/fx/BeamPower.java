...
public final class BeamPower implements ThaumFx.Effect {
    ...
    public void submit(PoseStack pose, SubmitNodeCollector collector, ThaumFx.View view, float partial) {
        ...
        boolean revealing = head.is(net.thaumcraft.registry.TCItems.GOGGLES) || head.is(net.thaumcraft.registry.TCItems.VOID_ROBE_HELMET) || head.is(net.thaumcraft.item.Revealing.REVEALING)
