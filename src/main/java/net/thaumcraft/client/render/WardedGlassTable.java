...
/**
 * O {@code UtilsFX.connectedTextureRefByID} da 4.2.3.5: dos oito vizinhos de uma face (um bit cada) para qual das 47
 * texturas do vidro protegido. <b>Gerado</b> do jar pelo {@code scratchpad/vidro-protegido.js}.
 */
final class WardedGlassTable {
