...
public final class TCMenus {
    ...
    public static final MenuType<net.thaumcraft.inventory.ArcaneChestMenu> ARCANE_CHEST =
            Registry.register(BuiltInRegistries.MENU, Thaumcraft.id("arcane_chest"),
                    new MenuType<>(net.thaumcraft.inventory.ArcaneChestMenu::new, FeatureFlags.VANILLA_SET));
    ...
    public static final MenuType<net.thaumcraft.inventory.HandMirrorMenu> HAND_MIRROR =
    ...
    public static final MenuType<net.thaumcraft.inventory.GolemMenu> GOLEM = Registry.register(
            ...
            new net.fabricmc.fabric.api.menu.v1.ExtendedMenuType<>(net.thaumcraft.inventory.GolemMenu::new,
                    net.minecraft.network.codec.ByteBufCodecs.VAR_INT));
