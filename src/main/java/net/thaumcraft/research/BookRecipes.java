...
public final class BookRecipes {
    ...
    private static void part1() {
        ...
        ref("PureTin", "PURETIN", () -> new net.minecraft.world.item.ItemStack(TCResources.get("native_tin_cluster")));
        ref("PureSilver", "PURESILVER", () -> new net.minecraft.world.item.ItemStack(TCResources.get("native_silver_cluster")));
        ref("PureLead", "PURELEAD", () -> new net.minecraft.world.item.ItemStack(TCResources.get("native_lead_cluster")));
        ...
        ref("TransTin", "TRANSTIN", () -> new net.minecraft.world.item.ItemStack(TCResources.get("tin_nugget"), 3));
        ref("TransSilver", "TRANSSILVER", () -> new net.minecraft.world.item.ItemStack(TCResources.get("silver_nugget"), 3));
        ref("TransLead", "TRANSLEAD", () -> new net.minecraft.world.item.ItemStack(TCResources.get("lead_nugget"), 3));
